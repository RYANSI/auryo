...
## Author
This application has been built by [RYAN AND jONAS]. It started out as a learning journey back in college Oct 2019, to start learning React, Redux and Electron. Since the first release in August 2017, the journey was incredibly educational. Over the next few months, Auryo has matured from a learning side-project into an escalated one. In a good sense.
